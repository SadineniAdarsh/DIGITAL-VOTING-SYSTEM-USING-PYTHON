...
gmailaddress = ("adarshsadineni123@gmail.com")
gmailpassword = ("adarshgmail")
...
while True:
    if votes_id==[]:
        ...
        if voter in votes_id:
            ...
            mailto = input("What email address do you want to send the msg\n")
            msg = ("You have voted \n \n Thanks_for_voting \n \n ('Have a nice day')")
            ...
            if vote==1: 
                ...
                nom_2_votes+=1
                print("thank you for casting your vot❤")
